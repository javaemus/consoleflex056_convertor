...
public class apf
{
	...
	*/
	...
	public static Memory_ReadAddress apf_imagination_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress( 0x00000, 0x003ff, apf_video_r),
		new Memory_ReadAddress( 0x00400, 0x007ff, apf_video_r),
		new Memory_ReadAddress( 0x00800, 0x00bff, apf_video_r),
		new Memory_ReadAddress( 0x00c00, 0x00fff, apf_video_r),
		new Memory_ReadAddress( 0x01000, 0x01fff, apf_video_r),
		new Memory_ReadAddress( 0x01000, 0x013ff, apf_video_r),
		new Memory_ReadAddress( 0x01400, 0x017ff, apf_video_r),
		new Memory_ReadAddress( 0x01800, 0x01bff, apf_video_r),
		new Memory_ReadAddress( 0x01c00, 0x01fff, apf_video_r),
		new Memory_ReadAddress( 0x02000, 0x03fff, apf_pia_0_r),		
		new Memory_ReadAddress( 0x04000, 0x047ff, MRA_BANK1),
		new Memory_ReadAddress( 0x04800, 0x04fff, MRA_BANK2),
		new Memory_ReadAddress( 0x05000, 0x057ff, MRA_BANK3),
		new Memory_ReadAddress( 0x05800, 0x05fff, MRA_BANK4),
		new Memory_ReadAddress( 0x06000, 0x063ff, apf_pia_1_r),
		new Memory_ReadAddress( 0x06400, 0x064ff, serial_r),
		new Memory_ReadAddress( 0x06500, 0x06500, apf_wd179x_status_r),
		new Memory_ReadAddress( 0x06501, 0x06501, apf_wd179x_track_r),
		new Memory_ReadAddress( 0x06502, 0x06502, apf_wd179x_sector_r),
		new Memory_ReadAddress( 0x06503, 0x06503, apf_wd179x_data_r),
		new Memory_ReadAddress( 0x06800, 0x077ff, MRA_ROM),
		new Memory_ReadAddress( 0x07800, 0x07fff, MRA_NOP),
		new Memory_ReadAddress( 0x08000, 0x09fff, MRA_ROM),
		new Memory_ReadAddress( 0x0a000, 0x0dfff, MRA_RAM),
		new Memory_ReadAddress( 0x0e000, 0x0e7ff, MRA_BANK5),
		new Memory_ReadAddress( 0x0e800, 0x0efff, MRA_BANK6),
		new Memory_ReadAddress( 0x0f000, 0x0f7ff, MRA_BANK7),
		new Memory_ReadAddress( 0x0f800, 0x0ffff, MRA_BANK8),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	
	public static Memory_WriteAddress apf_imagination_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x00000, 0x003ff, apf_video_w),
		new Memory_WriteAddress( 0x00400, 0x007ff, apf_video_w),
		new Memory_WriteAddress( 0x00800, 0x00bff, apf_video_w),
		new Memory_WriteAddress( 0x00c00, 0x00fff, apf_video_w),
		new Memory_WriteAddress( 0x01000, 0x01fff, apf_video_w),
		new Memory_WriteAddress( 0x01000, 0x013ff, apf_video_w),
		new Memory_WriteAddress( 0x01400, 0x017ff, apf_video_w),
		new Memory_WriteAddress( 0x01800, 0x01bff, apf_video_w),
		new Memory_WriteAddress( 0x01c00, 0x01fff, apf_video_w),
		new Memory_WriteAddress( 0x02000, 0x02003, pia_0_w),
		new Memory_WriteAddress( 0x04000, 0x05fff, MWA_ROM),
		new Memory_WriteAddress( 0x06000, 0x063ff, apf_pia_1_w),
		new Memory_WriteAddress( 0x06400, 0x064ff, serial_w),
		new Memory_WriteAddress( 0x06500, 0x06500, apf_wd179x_command_w),
		new Memory_WriteAddress( 0x06501, 0x06501, apf_wd179x_track_w),
		new Memory_WriteAddress( 0x06502, 0x06502, apf_wd179x_sector_w),
		new Memory_WriteAddress( 0x06503, 0x06503, apf_wd179x_data_w),
		new Memory_WriteAddress( 0x06600, 0x06600, apf_dischw_w),
		new Memory_WriteAddress( 0x0a000, 0x0dfff, MWA_RAM),
		new Memory_WriteAddress( 0x0e000, 0x0ffff, MWA_ROM),
	...
	public static Memory_WriteAddress apf_m1000_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x00000, 0x003ff, apf_video_w),
		new Memory_WriteAddress( 0x00400, 0x007ff, apf_video_w),
		new Memory_WriteAddress( 0x00800, 0x00bff, apf_video_w),
		...
		new Memory_WriteAddress( 0x01800, 0x01bff, apf_video_w),
		new Memory_WriteAddress( 0x01c00, 0x01fff, apf_video_w),
		new Memory_WriteAddress( 0x02000, 0x03fff, apf_pia_0_w),		
		new Memory_WriteAddress( 0x04000, 0x05fff, MWA_ROM),
		new Memory_WriteAddress( 0x0a000, 0x0dfff, MWA_RAM),
		new Memory_WriteAddress( 0x0e000, 0x0ffff, MWA_ROM),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	...
	static InputPortPtr input_ports_apf_m1000 = new InputPortPtr(){ public void handler() { 
		/* line 0 */
		PORT_START
	...
	static InputPortPtr input_ports_apf_imagination = new InputPortPtr(){ public void handler() { 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_apfimag = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_apfm1000 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION(0x10000+0x0800,REGION_CPU1,0);
