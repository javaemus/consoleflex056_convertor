...
public class mc10
{
	...
	public static Memory_ReadAddress mc10_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress( 0x0000, 0x001f, m6803_internal_registers_r ),
		new Memory_ReadAddress( 0x0020, 0x007f, MRA_NOP ), /* unused */
		new Memory_ReadAddress( 0x0080, 0x00ff, MRA_RAM ), /* 6803 internal RAM */
		new Memory_ReadAddress( 0x0100, 0x3fff, MRA_NOP ), /* unused */
		new Memory_ReadAddress( 0x4000, 0x4fff, MRA_RAM ),
	//	new Memory_ReadAddress( 0x5000, 0xbffe, MRA_RAM ), /* expansion RAM */
		new Memory_ReadAddress( 0xbfff, 0xbfff, mc10_bfff_r ),
	//	new Memory_ReadAddress( 0xc000, 0xdfff, MWA_ROM ), /* expansion ROM */
		new Memory_ReadAddress( 0xe000, 0xffff, MRA_ROM ), /* ROM */
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_WriteAddress mc10_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x001f, m6803_internal_registers_w ),
		new Memory_WriteAddress( 0x0020, 0x007f, MWA_NOP ), /* unused */
		new Memory_WriteAddress( 0x0080, 0x00ff, MWA_RAM ), /* 6803 internal RAM */
		new Memory_WriteAddress( 0x0100, 0x3fff, MWA_NOP ), /* unused */
		new Memory_WriteAddress( 0x4000, 0x4fff, mc10_ram_w ),
	//	new Memory_WriteAddress( 0x5000, 0xbffe, MWA_RAM ), /* expansion RAM */
		new Memory_WriteAddress( 0xbfff, 0xbfff, mc10_bfff_w ),
	//	new Memory_WriteAddress( 0xc000, 0xdfff, MWA_ROM ), /* expansion ROM */
		new Memory_WriteAddress( 0xe000, 0xffff, MWA_ROM ), /* ROM */
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	
	public static IO_ReadPort mc10_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_ReadPort( M6803_PORT1, M6803_PORT1, mc10_port1_r ),
		new IO_ReadPort( M6803_PORT2, M6803_PORT2, mc10_port2_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	
	public static IO_WritePort mc10_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_WritePort( M6803_PORT1, M6803_PORT1, mc10_port1_w ),
		new IO_WritePort( M6803_PORT2, M6803_PORT2, mc10_port2_w ),
