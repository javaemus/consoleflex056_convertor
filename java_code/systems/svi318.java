...
public class svi318
{
	...
	public static Memory_WriteAddress writemem[]={
	    ...
	    new Memory_WriteAddress( 0x0000, 0x7fff, svi318_writemem0 ),
	    new Memory_WriteAddress( 0x8000, 0xffff, svi318_writemem1 ),
	...
	*/
	...
	(
	    ...
	    new int[] { 75 },
	    new ReadHandlerPtr[] { svi318_psg_port_a_r },
	    new ReadHandlerPtr[] { NULL },
	    new WriteHandlerPtr[] { NULL },
	    new WriteHandlerPtr[] { svi318_psg_port_b_w }
	);
