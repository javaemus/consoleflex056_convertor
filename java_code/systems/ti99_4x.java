...
public class ti99_4x
{
	...
	*/
	...
	static InputPortPtr input_ports_ti99_4a = new InputPortPtr(){ public void handler() { 
	...
	static InputPortPtr input_ports_ti99_4 = new InputPortPtr(){ public void handler() { 
	...
	*/
	static SN76496interface tms9919interface = new SN76496interface
	(
		1,				/* one sound chip */
		new int[] { 3579545 },	/* clock speed. connected to the TMS9918A CPUCLK pin... */
		new int[] { 75 }			/* Volume.  I don't know the best value. */
	);
	...
	*/
	...
	static RomLoadPtr rom_ti99_4 = new RomLoadPtr(){ public void handler(){ 
		/*CPU memory space*/
	...
	static RomLoadPtr rom_ti99_4a = new RomLoadPtr(){ public void handler(){ 
		/*CPU memory space*/
		/* 0x4000 extra RAM for paged cartidges */
	#if 1
