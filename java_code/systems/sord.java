...
public class sord
{
	...
	*/
	...
	static InputPortPtr input_ports_sord_m5 = new InputPortPtr(){ public void handler() { 
		/* line 0 */
		PORT_START
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sordm5 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION(0x010000, REGION_CPU1,0);
		ROM_LOAD("sordint.rom",0x0000, 0x02000, 0x078848d39);
	ROM_END(); }}; 
	
	
	static RomLoadPtr rom_srdm5fd5 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION(0x010000, REGION_CPU1,0);
		ROM_LOAD("sordint.rom",0x0000, 0x02000, 0x078848d39);
