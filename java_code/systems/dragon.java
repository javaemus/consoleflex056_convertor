...
public class dragon
{
	...
	public static Memory_ReadAddress dragon32_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress( 0x0000, 0x7fff, MRA_RAM ),
		new Memory_ReadAddress( 0x8000, 0xbfff, MRA_ROM ),
		new Memory_ReadAddress( 0xc000, 0xfeff, MRA_ROM ), /* cart area */
		new Memory_ReadAddress( 0xff00, 0xff1f, pia_0_r ),
		new Memory_ReadAddress( 0xff20, 0xff3f, coco_pia_1_r ),
		new Memory_ReadAddress( 0xff40, 0xff5f, coco_cartridge_r ),
		new Memory_ReadAddress( 0xff60, 0xffef, MRA_NOP ),
		new Memory_ReadAddress( 0xfff0, 0xffff, dragon_mapped_irq_r ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_WriteAddress dragon32_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x7fff, coco_ram_w ),
		new Memory_WriteAddress( 0x8000, 0xbfff, MWA_ROM ),
		new Memory_WriteAddress( 0xc000, 0xfeff, MWA_ROM ), /* cart area */
		new Memory_WriteAddress( 0xff00, 0xff1f, pia_0_w ),
		new Memory_WriteAddress( 0xff20, 0xff3f, pia_1_w ),
		new Memory_WriteAddress( 0xff40, 0xff5f, coco_cartridge_w ),
		new Memory_WriteAddress( 0xff60, 0xffbf, MWA_NOP ),
		new Memory_WriteAddress( 0xffc0, 0xffdf, sam_w ),
		new Memory_WriteAddress( 0xffe0, 0xffff, MWA_NOP ),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_ReadAddress d64_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress( 0x0000, 0x7fff, MRA_RAM ),
		new Memory_ReadAddress( 0x8000, 0xfeff, MRA_BANK1 ),
		new Memory_ReadAddress( 0xff00, 0xff1f, pia_0_r ),
		new Memory_ReadAddress( 0xff20, 0xff3f, coco_pia_1_r ),
		new Memory_ReadAddress( 0xff40, 0xff8f, coco_cartridge_r ),
		new Memory_ReadAddress( 0xff90, 0xffef, MRA_NOP ),
		new Memory_ReadAddress( 0xfff0, 0xffff, dragon_mapped_irq_r ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_WriteAddress d64_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x7fff, coco_ram_w),
		new Memory_WriteAddress( 0x8000, 0xfeff, MWA_BANK1 ),
		new Memory_WriteAddress( 0xff00, 0xff1f, pia_0_w ),
		new Memory_WriteAddress( 0xff20, 0xff3f, pia_1_w ),
		new Memory_WriteAddress( 0xff40, 0xff8f, coco_cartridge_w ),
		new Memory_WriteAddress( 0xff90, 0xffbf, MWA_NOP ),
		new Memory_WriteAddress( 0xffc0, 0xffdf, sam_w ),
		new Memory_WriteAddress( 0xffe0, 0xffff, MWA_NOP),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_ReadAddress coco3_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		...
		new Memory_ReadAddress( 0xe000, 0xfdff, MRA_BANK8 ),
		new Memory_ReadAddress( 0xfe00, 0xfeff, MRA_BANK9 ),
		new Memory_ReadAddress( 0xff00, 0xff1f, pia_0_r ),
		new Memory_ReadAddress( 0xff20, 0xff3f, coco3_pia_1_r ),
		new Memory_ReadAddress( 0xff40, 0xff8f, coco_cartridge_r ),
		new Memory_ReadAddress( 0xff90, 0xff97, coco3_gime_r ),
		new Memory_ReadAddress( 0xff98, 0xff9f, coco3_gimevh_r ),
		new Memory_ReadAddress( 0xffa0, 0xffaf, coco3_mmu_r ),
		new Memory_ReadAddress( 0xffb0, 0xffbf, paletteram_r ),
		new Memory_ReadAddress( 0xffc0, 0xffef, MRA_NOP ),
		new Memory_ReadAddress( 0xfff0, 0xffff, coco3_mapped_irq_r ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	 ...
	 */
	public static Memory_WriteAddress coco3_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		...
		new Memory_WriteAddress( 0xe000, 0xfdff, MWA_BANK8 ),
		new Memory_WriteAddress( 0xfe00, 0xfeff, MWA_BANK9 ),
		new Memory_WriteAddress( 0xff00, 0xff1f, pia_0_w ),
		new Memory_WriteAddress( 0xff20, 0xff3f, pia_1_w ),
		new Memory_WriteAddress( 0xff40, 0xff8f, coco_cartridge_w ),
		new Memory_WriteAddress( 0xff90, 0xff97, coco3_gime_w ),
		new Memory_WriteAddress( 0xff98, 0xff9f, coco3_gimevh_w ),
		new Memory_WriteAddress( 0xffa0, 0xffaf, coco3_mmu_w ),
		new Memory_WriteAddress( 0xffb0, 0xffbf, coco3_palette_w ),
		new Memory_WriteAddress( 0xffc0, 0xffdf, sam_w ),
		new Memory_WriteAddress( 0xffe0, 0xffff, MWA_NOP ),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cocoe = new RomLoadPtr(){ public void handler(){ 
	     ROM_REGION(0x18000,REGION_CPU1,0);
	...
	static RomLoadPtr rom_coco2 = new RomLoadPtr(){ public void handler(){ 
	     ROM_REGION(0x18000,REGION_CPU1,0);
	...
	static RomLoadPtr rom_coco2b = new RomLoadPtr(){ public void handler(){ 
	     ROM_REGION(0x18000,REGION_CPU1,0);
	...
	static RomLoadPtr rom_coco3p = new RomLoadPtr(){ public void handler(){ 
	     ROM_REGION(0x90000,REGION_CPU1,0);
