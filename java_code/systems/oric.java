...
public class oric
{
	...
	*/
	...
	static InputPortPtr input_ports_prav8d = new InputPortPtr(){ public void handler() { 
		INPUT_PORT_ORIC
	...
	static InputPortPtr input_ports_telstrat = new InputPortPtr(){ public void handler() { 
		INPUT_PORT_ORIC
		PORT_START
		/* vsync cable hardware. This is a simple cable connected to the video output
		to the monitor/television. The sync signal is connected to the cassette input
	...
	(
		...
		new ReadHandlerPtr[] { 0 },
		new WriteHandlerPtr[] { oric_psg_porta_write },
	...
	static RomLoadPtr rom_telstrat = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_prav8d = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_prav8dd = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_prav8dda = new RomLoadPtr(){ public void handler(){ 
	    ROM_REGION (0x10000+0x4000+0x0100+0x200,REGION_CPU1,0);
