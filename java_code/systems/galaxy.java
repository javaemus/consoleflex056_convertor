...
public class galaxy
{
	...
	static GfxLayout galaxy_charlayout = new GfxLayout
	(
		8, 13,	/* 8x8 characters */
		128,	/* 128 characters */
		1,		/* 1 bits per pixel */
		...
		new int[] {0*128*8, 1*128*8,  2*128*8,  3*128*8,
		 4*128*8, 5*128*8,  6*128*8,  7*128*8,
		 8*128*8, 9*128*8, 10*8*128, 11*128*8, 12*128*8},
		8 	/* each character takes 1 consecutive byte */
	);
	
	static GfxDecodeInfo galaxy_gfxdecodeinfo[] =
	{
		new GfxDecodeInfo(REGION_GFX1, 0x0000, galaxy_charlayout, 0, 2),
	...
	static const struct IODevice io_galaxy[] = new GfxDecodeInfo(
	    {
		IO_SNAPSHOT,		/* type */
		1,			/* count */
