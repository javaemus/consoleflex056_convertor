...
/* TIA *Read* Addresses */
                        /*          bit 6  bit 7				*/
#define	CXM0P	0x30	/* Read Collision M0-P1  M0-P0			*/
#define	CXM1P	0x31    /*                M1-P0  M1-P1			*/
#define	CXP0FB	0x32	/*                P0-PF  P0-BL			*/
#define	CXP1FB	0x33    /*                P1-PF  P1-BL			*/
#define	CXM0FB	0x34    /*                M0-PF  M0-BL			*/
#define	CXM1FB	0x35    /*                M1-PF  M1-BL			*/
#define	CXBLPF	0x36    /*                BL-PF  -----			*/
#define	CXPPMM	0x37    /*                P0-P1  M0-M1			*/
#define	INPT0	0x38    /* Read Pot Port 0						*/
#define	INPT1	0x39    /* Read Pot Port 1						*/
#define	INPT2	0x3A    /* Read Pot Port 2						*/
#define	INPT3	0x3B    /* Read Pot Port 3						*/
#define	INPT4	0x3C    /* Read Input (Trigger) 0				*/
#define	INPT5	0x3D    /* Read Input (Trigger) 1				*/
